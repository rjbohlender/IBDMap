...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        required=True,
        help="Total number of permutations in each run.",
    )
    parser.add_argument(
        "--nruns", type=int, required=True, help="Total number of runs."
    )
    parser.add_argument(
        "--gmap", type=str, required=True, help="Path to genetic map files."
    )
    parser.add_argument(
        "--at", type=int, default=0, help="The permutation set to start at."
    )
    parser.add_argument(
        "--unweighted", action="store_true", help="Use unweighted average."
    )
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Print the EVD to stdout.",
    )
    parser.add_argument(
        "--single", default=None, type=int, help="Run only a single chromosome."
    )
    parser.add_argument(
        "--no_avg",
        default=False,
    ...
    parser.add_argument(
        "--fdr", default=False, action="store_true", help="Control FDR instead of FWE."
    )
